...
VOICES = {
    ...
    'vctk_irish_m_p364': {'name': 'Irish male (VCTK)', 'accent': 'Irish', 'gender': 'Male', 'engine': 'chatterbox'},
    'vctk_irish_f_p288': {'name': 'Irish female (VCTK)', 'accent': 'Irish', 'gender': 'Female', 'engine': 'chatterbox'},
    'vctk_northernirish_m_p292': {'name': 'Northern Irish male (VCTK)', 'accent': 'Northern Irish', 'gender': 'Male', 'engine': 'chatterbox'},
    'vctk_northernirish_f_p293': {'name': 'Northern Irish female (VCTK)', 'accent': 'Northern Irish', 'gender': 'Female', 'engine': 'chatterbox'},
    'vctk_welsh_f_p253': {'name': 'Welsh female (VCTK)', 'accent': 'Welsh', 'gender': 'Female', 'engine': 'chatterbox'},
    'vctk_english_m_p256': {'name': 'English male (VCTK)', 'accent': 'British', 'gender': 'Male', 'engine': 'chatterbox'},
    'vctk_english_f_p277': {'name': 'English female (VCTK)', 'accent': 'British', 'gender': 'Female', 'engine': 'chatterbox'},
    'vctk_canadian_m_p316': {'name': 'Canadian male (VCTK)', 'accent': 'Canadian', 'gender': 'Male', 'engine': 'chatterbox'},
    'vctk_canadian_f_p312': {'name': 'Canadian female (VCTK)', 'accent': 'Canadian', 'gender': 'Female', 'engine': 'chatterbox'},

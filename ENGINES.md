...
| Azure Speech Standard native AU/IE/ZA voices (2026-08-15) | **Accent pass / original trio rejected:** Darren, Connor and Luke had spot-on Australian, Irish and South African accents, but all sounded robotic and degraded. The exact 24 kHz/160 kbps trio is not production-approved. In a controlled 24 kHz/48 kbps William comparison, Azure was slightly better than Edge, proving the endpoint did not cause the earlier relative degradation. A 737-word, correctly processed, 48 kHz lossless William/Connor/Luke gate is structurally verified and awaiting listening. None is production-approved yet. | Azure Speech F0, UK South |

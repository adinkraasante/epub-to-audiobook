...
| EdgeTTS accented English voices (2026-08-14) | The only currently heard regional-accent option that comes close. All tested Chinese company names were still pronounced badly, so it is not approved for Chinese-business nonfiction without a supported pronunciation fix. | Microsoft cloud service via unofficial `edge-tts` interface |
| Azure Speech Standard native AU/IE/ZA voices (2026-08-15) | **Accent pass / overall rejection:** Darren, Connor and Luke had spot-on Australian, Irish and South African accents, but all sounded robotic and degraded. The exact 24 kHz/160 kbps MP3 path is not production-approved. Microsoft documents a separate high-fidelity 48 kHz standard model, so one lossless control remains justified; prosody cannot replace the voices' core timbre. | Azure Speech F0, UK South |

...
| Azure Speech Standard native AU/IE/ZA voices (2026-08-15) | **Accent pass / original trio rejected:** Darren, Connor and Luke had spot-on Australian, Irish and South African accents, but all sounded robotic and degraded. The exact 24 kHz/160 kbps trio is not production-approved. In a controlled 24 kHz/48 kbps William comparison, Azure was slightly better than Edge, proving the endpoint did not cause the earlier relative degradation. This is not absolute production approval. Microsoft also documents a separate high-fidelity 48 kHz standard model; prosody cannot replace a voice's core timbre. | Azure Speech F0, UK South |

...
| IndexTTS-2.5 / Arthur focused gate (2026-08-15) | **First gate rejected at its joins; corrected clip ready.** Both original arms garbled at the exact upstream 200 ms joins (native 30.151/57.983 s; prepared 27.632/59.620 s). The official 120-token splitter had cut unsafe phrase boundaries. Our explicit path also passed raw `1.5` while disabling Index normalization. The one free-T4 follow-up renders nine complete sentences, says “one point five”, and joins lossless WAV; its 85.529 s MP3 fully decodes. Do not promote until Dave hears it. | Kaggle Tesla T4, free compute |

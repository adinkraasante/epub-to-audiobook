...
| Gemini 3.1 Flash TTS / Achernar | Free-only adapter live; exact preview ready; 8–10 minute gate pending | GBP0 on an unbilled Developer API Free project | Short Studio sample was very good. The exact 81.576 s app preview is cached and validated. Current official SDK/API only, 2–3 minute paragraph packs, one attempt, resumable cache, no paid/Vertex/Batch fallback. Free content may train Google products; quota may limit book feasibility. |

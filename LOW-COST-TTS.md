...
| [IndexTTS-2.5](https://github.com/index-tts/index-tts/blob/39207d91c30899cad1e7c1b9eb678c241f678e55/README.md) | Stable `v2.5.0` adds voice cloning, token-aware 120-token splitting, 200 ms joins, `duration_factor` pace control and CMU English pronunciation annotations. The Bilibili Model Use License is not permissive OSS. | **Free-T4 FP32 capacity passed, first audio gate failed at joins:** 10.982 GiB peak reserved. Dave's ~28/~58 s defects coincide exactly with upstream's inserted joins, and our prepared input mishandled `1.5`. One corrected complete-sentence/“one point five” 85.529 s arm is validated and ready to hear. No long-form until accepted. |

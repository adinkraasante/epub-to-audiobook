...
|--------|--------------|---------------------------|-----------------|--------------------|
| [Azure Speech](https://azure.microsoft.com/en-gb/pricing/details/speech/) | F0 includes 500k Neural chars/month; checked UK South S0 retail meter ~GBP11.36/1M chars | F0 free if the monthly hard cap is respected; S0 ~GBP6.82 | **F0 only** | Strong AU/IE/ZA native inventory plus official SSML number/currency/IPA/lexicon controls. No current credentials/integration; never auto-upgrade to paid. |
